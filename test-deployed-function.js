...
async function runTests() {
  try {
    ...
    const deliveryPayload = {
      idempotency_key: "test-delivery-" + Date.now(),
      shop_id: "18",
      items: [{ menu_item_id: "doc_1786657005423_bgzhw", quantity: 1 }],
      delivery_type: "delivery",
      delivery_schedule_mode: "express",
      delivery_coordinates: { lat: -25.983093, lng: 28.206892 }, // 2.4km from shop
      tip_amount: 5,
      payment_method: "card",
      customer_details: {
        name: "Test User",
        ...
        city: "Tembisa",
        delivery_instructions: "Please hurry"
      }
    };
    const delRes = await createOrder(deliveryPayload);
    console.log("Delivery order success:", delRes.data);
